...
global.swissclac.display.fixedPointDisplay = function (numDecimalPlaces, maxLength) {
	this._display = "";
...
global.swissclac.display.fixedPointDisplay.prototype.getCurrentDisplay = function () {
	var str = "";
...
global.swissclac.display.fixedPointDisplay.prototype.addDigit = function (digit) {
...
global.swissclac.display.fixedPointDisplay.prototype.negate = function () {
	this._isNegative = !this._isNegative;
};

// Removes the last character if possible
global.swissclac.display.fixedPointDisplay.prototype.backspace = function () {
...
// Clears the display
global.swissclac.display.fixedPointDisplay.prototype.clear = function () {
	this._display = "";
};

// Returns _display as a numeric value
global.swissclac.display.fixedPointDisplay.prototype.getDisplayValue = function () {
