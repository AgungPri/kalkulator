...
global.swissclac.display.numericDisplay = function (groupDigits, maxLength) {
	this._display = "0";
...
global.swissclac.display.numericDisplay.prototype.getCurrentDisplay = function () {
	return (this._groupDigits)
		? global.swissclac.lib.format.groupDigits(this._display)
		: this._display;
};

// Adds the given character to the display, if appropriate.
// The only valid digits are: 0...9, . (decimal). Must be a string.
global.swissclac.display.numericDisplay.prototype.addDigit = function (digit) {
...
global.swissclac.display.numericDisplay.prototype.negate = function () {
...
global.swissclac.display.numericDisplay.prototype.backspace = function () {
...
// Clears the display
global.swissclac.display.numericDisplay.prototype.clear = function () {
	this._display = "0";
};

// Returns _display as a numeric value
global.swissclac.display.numericDisplay.prototype.getDisplayValue = function () {
	return parseFloat(this._display);
};

// Formats the value and sets the display. "val" should be a number.
global.swissclac.display.numericDisplay.prototype.setDisplayValue = function (val) {
